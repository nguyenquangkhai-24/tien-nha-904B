...
- PIN 6–12 chữ số, lưu PBKDF2-SHA256 với salt ngẫu nhiên; backend tự nâng cấp và xóa plaintext legacy ngay khi khởi động, nếu không làm được thì không khởi động.
